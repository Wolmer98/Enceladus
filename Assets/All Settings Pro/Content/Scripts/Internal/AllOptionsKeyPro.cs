public static class AllOptionsKeyPro
{
    ...
    public const string MotionBlur = "GameName.MotionBlur";
    public const string BlendWeight = "GameName.BlendWeight";
    public const string Volumen = "GameName.Volumen";
    public const string MasterVolume = "GameName.MasterVolume";
    public const string MusicVolume = "GameName.MusicVolume";
    public const string SFXVolume = "GameName.SFXVolume";
