...
public class DistortionEffect : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        //Fetch the second material, often trail material in particle systems.
        //ParticleSystemRenderer rn = GetComponent<ParticleSystemRenderer>();
        //if (Renderer.sharedMaterials[0] == null && Renderer.GetType() == rn.GetType())
        //{
        //    Renderer = rn;
        //    Material = rn.trailMaterial;
        //    Debug.Log(Material);
        //}
